...
CUDA_VISIBLE_DEVICES=3 python train_trades_cifar10.py --model preactresnet --AT-method ST_el  --dataset CIFAR10 --gpu-id 1 --seed 6 --list_aug 3 5 --alpha 2 --tmp 1

# 减小 alpha
CUDA_VISIBLE_DEVICES=0 python train_trades_cifar10.py --model preactresnet --AT-method ST_el  --dataset CIFAR10 --gpu-id 1 --seed 7 --list_aug 3 5 --alpha 0.2 --tmp 1
