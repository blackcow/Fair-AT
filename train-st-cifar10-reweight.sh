...
#wait
echo "开始训练 6......"
CUDA_VISIBLE_DEVICES=1 python train_trades_cifar10.py --model preactresnet --AT-method ST_reweight  --dataset CIFAR10 --gpu-id 1 --seed 6 --reweight 1  --discrepancy 0
wait
echo "开始训练 7......"
CUDA_VISIBLE_DEVICES=1 python train_trades_cifar10.py --model preactresnet --AT-method ST_reweight  --dataset CIFAR10 --gpu-id 1 --seed 7 --reweight 5  --discrepancy 0
wait
echo "开始训练 8......"
CUDA_VISIBLE_DEVICES=1 python train_trades_cifar10.py --model preactresnet --AT-method ST_reweight  --dataset CIFAR10 --gpu-id 1 --seed 8 --reweight 10  --discrepancy 0
wait
echo "开始训练 8......"
CUDA_VISIBLE_DEVICES=1 python train_trades_cifar10.py --model preactresnet --AT-method ST_reweight  --dataset CIFAR10 --gpu-id 1 --seed 9 --reweight 10  --discrepancy 1
wait
echo "结束训练......"
