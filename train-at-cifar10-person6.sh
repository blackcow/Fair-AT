...
wait
echo "开始训练 4......"
CUDA_VISIBLE_DEVICES=2 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_rm  --dataset CIFAR10 --gpu-id 3 --seed 1 --rmlabel 6 --percent 0.8
wait
echo "开始训练 5......"
CUDA_VISIBLE_DEVICES=2 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_rm  --dataset CIFAR10 --gpu-id 3 --seed 1 --rmlabel 6 --percent 1
wait
echo "结束训练......"