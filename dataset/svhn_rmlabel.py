...
from dataset.utilsmy import download_url, check_integrity, verify_str_arg
from dataset.visionmy import VisionDataset


class SVHNKP(VisionDataset):
    ...
    def __init__(
        ...
        super(SVHNKP, self).__init__(root, args, transform=transform, target_transform=None, )
        ...
        self.labels = [i[1] for i in sorted_nums]
