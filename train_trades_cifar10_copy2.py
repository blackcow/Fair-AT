...
parser.add_argument('--model-dir', default='./model-cifar-wideResNet/AT/',
...
print(args)
# settings
factors = '_depth' + str(args.depth) + '_' + 'widen' + str(args.widen_factor) + '_' + 'drop' + str(args.droprate)
model_dir = args.model_dir + 'e' +str(args.epsilon) + factors
