...
wait
#echo "开始训练 3......"
#CUDA_VISIBLE_DEVICES=1 python train_trades_cifar10.py --model preactresnet --AT-method AT_reweight  --dataset CIFAR10 --gpu-id 1 --seed 3 --reweight 0.1  --discrepancy 3
#wait
#echo "开始训练 4......"
#CUDA_VISIBLE_DEVICES=1 python train_trades_cifar10.py --model preactresnet --AT-method AT_reweight  --dataset CIFAR10 --gpu-id 1 --seed 4 --reweight 1  --discrepancy 3
#wait
#echo "开始训练 5......"
#CUDA_VISIBLE_DEVICES=1 python train_trades_cifar10.py --model preactresnet --AT-method AT_reweight  --dataset CIFAR10 --gpu-id 1 --seed 5 --reweight 5  --discrepancy 3
wait
#echo "开始训练 6......"
