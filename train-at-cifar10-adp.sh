...
echo "开始训练 1......"
CUDA_VISIBLE_DEVICES=3 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_ST_adp  --dataset CIFAR10 --gpu-id 3 --seed 1 --beta 1 --beta_aug 6 --alpha 1.1 --list_aug 2 3 4 5
wait
echo "开始训练 2......"
