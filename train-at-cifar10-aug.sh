...
wait
echo "开始训练 2......"
CUDA_VISIBLE_DEVICES=3 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_aug_pgd --dataset CIFAR10 --gpu-id 3 --seed 2 --beta_aug 1
wait
echo "开始训练 3......"
CUDA_VISIBLE_DEVICES=3 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_aug_pgd --dataset CIFAR10 --gpu-id 3 --seed 3 --beta_aug 2
wait
echo "开始训练 4......"
CUDA_VISIBLE_DEVICES=3 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_aug_pgd --dataset CIFAR10 --gpu-id 3 --seed 4 --beta_aug 4
wait
echo "开始训练 5......"
CUDA_VISIBLE_DEVICES=3 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_aug_pgd --dataset CIFAR10 --gpu-id 3 --seed 5 --beta_aug 6
wait
echo "结束训练......"