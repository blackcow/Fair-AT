...
# 在每个 seed 下使用不同的超参数
echo "开始训练 1......"
CUDA_VISIBLE_DEVICES=3 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_loss_adp  --dataset CIFAR10 --gpu-id 3 --seed 1 --beta 0.5 --beta_aug 6
wait
echo "开始训练 2......"
CUDA_VISIBLE_DEVICES=2 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_loss_adp  --dataset CIFAR10 --gpu-id 2 --seed 2 --beta 1 --beta_aug 6
wait
echo "开始训练 3......"
CUDA_VISIBLE_DEVICES=1 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_loss_adp  --dataset CIFAR10 --gpu-id 1 --seed 3 --beta 1 --beta_aug 12
wait
echo "开始训练 4......"
