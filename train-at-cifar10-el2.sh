...
echo "开始训练 1......"
CUDA_VISIBLE_DEVICES=0 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_el_li2  --dataset CIFAR10 --gpu-id 1 --seed 6 --alpha 0.1 --tmp 1
wait
echo "开始训练 2......"
CUDA_VISIBLE_DEVICES=0 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_el_li2  --dataset CIFAR10 --gpu-id 1 --seed 7 --alpha 1 --tmp 1
wait
echo "开始训练 3......"
CUDA_VISIBLE_DEVICES=0 python train_trades_cifar10.py --model preactresnet --AT-method TRADES_el_li2  --dataset CIFAR10 --gpu-id 1 --seed 8 --alpha 5 --tmp 1
wait
